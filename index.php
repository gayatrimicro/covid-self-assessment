  ...
  <body>
	...
	<table id="address" hidden>
	  <tr>
		...
		<td class="wideField" colspan="2"><input class="field" name="street_address" id="route" disabled="true"/></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<td class="slimField"><input class="field" id="administrative_area_level_1" name="state" disabled="true"/></td>
	  ...
	  <tr>
		...
		<td class="wideField" colspan="3"><input class="field" id="website" name="website" disabled="true"/></td>
	  </tr>
	  <tr>
		<td class="label">Organization</td>
		<td class="wideField" colspan="3"><input class="field" id="name" name="name" disabled="true"/></td>
	  </tr>
	  <tr>
		<td class="wideField" style="text-align: center;" colspan="4"><hr><h3>Select Category to know your competitors</h3></td>
	  </tr>
	  <tr>
		<td class="label">Category</td>
		<td class="wideField" colspan="3">
			<select name="category" required id="e1">
